import styles from '@/styles/artists/dashboard.module.scss'; // Import the CSS module for styling
...
export default ArtistSidebar; // Export the component for use in other parts of the application
