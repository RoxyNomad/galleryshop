...
import { Artwork } from '@/src/services/types'; // Import the Artwork type definition
import { fetchArtworksByCategory } from '@/src/utils/data'; // Function to fetch artworks based on category
import { useSort } from '@/src/hooks/useSort'; // Custom hook for sorting functionality
import Image from 'next/image';
import SelectionBar from '@/src/components/shop/SelectionBarPhotography'; // Component for sorting and filtering options
import styles from '@/src/styles/photography/photography.module.scss'; // Import SCSS styles
